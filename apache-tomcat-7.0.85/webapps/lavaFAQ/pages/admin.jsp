...
<html lang="zh-cn">
  <head>
	  ...
	  <!-- Main stylesheet -->
	  <link href="<%=path%>/pages/style/style.css" rel="stylesheet">
	  <!-- Widgets stylesheet -->
  ...
  <body>
    ...
    <div class="conjtainer">
      ...
      <div class="navbar-header">
		  ...
		  <a href="<%=basePath%>pages/main/admin" class="navbar-brand hidden-lg">首页</a>
		</div>
      ...
      <nav class="collapse navbar-collapse bs-navbar-collapse" role="navigation">         
        ...
        <ul class="nav navbar-nav">  
          ...
          <li >
            <a href="http://www.slcupc.edu.cn/" target="_Blank"><i></i> 中国石油大学胜利学院</a>
            <!-- Dropdown -->
        ...
        <ul class="nav navbar-nav pull-right">
          <li class="dropdown pull-right">            
            <a data-toggle="dropdown" class="dropdown-toggle" href="#">
              <i class="icon-user"></i> ${sessionScope.username} <b class="caret"></b>              
            </a>
            
            <!-- Dropdown menu -->
            <ul class="dropdown-menu">
              <li><a href="<%=basePath%>pages/main/personInf" target="ifrmain"><i class="icon-user"></i> 资料</a></li>
              <li><a href="<%=basePath%>pages/main/updatePassword" target="ifrmain"><i class="icon-cogs"></i> 修改密码</a></li>
              <li><a href="<%=basePath%>pages/main/quit"><i class="icon-off"></i> 退出</a></li>
            </ul>
          </li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-8">
          <!-- Logo. -->
          <div class="logo">
            <h1><a href="#">CRM<span class="bold"></span></a></h1>
...
<div class="content">
        ...
        <ul id="nav">
          <!-- Main menu with font awesome icon -->
            ...
            <ul>
              ...
              <li><a href="<%=basePath%>pages/main/widgets1" class="open" target="ifrmain"><i class="icon-home"></i> 首页</a>
            <!-- Sub menu markup 
            <ul>
              <li><a href="#">Submenu #1</a></li>
              <li><a href="#">Submenu #2</a></li>
          ...
          <li class="has_sub"><a href="#"><i class="icon-list-alt"></i> 用户管理  <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="<%=basePath%>pages/main/chackUser" target="ifrmain">查看用户</a></li>
               <li><a href="<%=basePath%>pages/main/GrantUser" target="ifrmain">用户授权</a></li>
            </ul>
             
          </li>  
          <li class="has_sub"><a href="#"><i class="icon-file-alt"></i> 会议室管理 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="<%=basePath%>pages/con/tocheckCon"target="ifrmain">查看会议室</a></li>
              <li><a href="<%=basePath%>pages/con/addcon"target="ifrmain"">添加会议室</a></li>
                <li><a href="<%=basePath%>pages/con/modcon"target="ifrmain"">修改会议室 </a></li>
            </ul>
          </li> 
          <li class="has_sub"><a href="#"><i class="icon-file-alt"></i> 我的任务 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="<%=basePath%>pages/main/toAllApply"target="ifrmain"">查看申请</a></li>
            </ul>
          </li>                             
          <li><a href="<%=basePath%>pages/main/toCla" target="ifrmain"><i class="icon-calendar"></i>日历</a></li>
        </ul>
    </div>
    ...
    <!-- Sidebar ends -->
  	  	...
  	  	<!-- Main bar -->
  	<div class="mainbar">
      <iframe src="<%=basePath%>pages/main/widgets1" name="ifrmain" class="container" style="height: 1500px;border:0px;padding:0px;margin:0px"scrolling="no" ></iframe>
	<!--     Page heading
	    <div class="page-head">
