...
<div class="login" style="margin-top:50px;">
    ...
    <div class="web_qr_login" id="web_qr_login" style="display: block; height: 235px;">    
			...
			<div class="login_form">
				<form action="<%=basePath%>pages/login/login" name="loginform" accept-charset="utf-8" id="login_form" class="loginForm" method="post"><input type="hidden" name="did" value="0"/>
  ...
  <!--注册-->
    ...
    <div class="web_login"><form name="form2" id="regUser" accept-charset="utf-8"  action="<%=basePath%>login/register" method="post">
                ...
                <li>
                 <label for="qq" class="input-tips2">邮箱：</label>
                    <div class="inputOuter2">
                        ...
                        <input type="text" id="qq" name="qq" maxlength="24" class="inputstyle2"/>
                    </div>
...
<div class="jianyi">*使用ie8以上版本ie浏览器*本页版权归yufu所有。All Rights Reserved</div>
</body></html>