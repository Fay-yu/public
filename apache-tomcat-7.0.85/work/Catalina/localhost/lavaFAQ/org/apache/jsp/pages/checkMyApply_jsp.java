 ...
 * Generated at: 2018-11-29 02:51:47 UTC
...
public final class checkMyApply_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<i class=\"icon-table\"></i> 查看我的预约\r\n");
      out.write("\t\t\t\t</h2>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"pull-left\">查看预约</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getFusername());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getFcrmname());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getApplytime());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getTheme());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getBooktimebegin());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>");
      out.print(person.getBooktimeend());
      out.write("</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>正在审批中 <span class=\"label label-warning\">Applying</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>已预约成功！<span class=\"label label-success\">Success</span></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>已拒绝！<span class=\"label label-danger\">Refuse</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>已完成！<span class=\"label label-success\">Refuse</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"btn-group1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"/lavaFAQ/pages/user/deleteApply?id=");
      out.print(person.getId());
      out.write("&userid=");
      out.print(person.getUserid());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"return myclick();\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"text-decoration:none; \r\n");
      out.write("color:#333; \"> 取消申请\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t<div class=\"btn-group1\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"/lavaFAQ/pages/user/updateApply?id=");
      out.print(person.getId());
      out.write("&userid=");
      out.print(person.getUserid());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"return yourclick();\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"text-decoration:none; \r\n");
      out.write("color:#333; \"> <input\r\n");
      ...
      out.print(person.getId());
      out.write("\" /> <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"label label-success\">完成此次预约</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
      ...
      out.write("\t\t}\r\n");
      out.write("\r\n");
      out.write("\t\tfunction yourclick() {\r\n");
      out.write("\t\t\tvar r = confirm(\"确定完成吗?\");\r\n");
      out.write("\t\t\tif (r == true) {\r\n");
      out.write("\t\t\t\treturn true;\r\n");
      out.write("\t\t\t}\r\n");
      out.write("\t\t\treturn false;\r\n");
