 ...
 * Generated at: 2018-11-29 02:47:24 UTC
...
public final class addApply_jsp extends org.apache.jasper.runtime.HttpJspBase
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<i class=\"icon-table\"></i> 申请预约会议室\r\n");
      out.write("\t\t\t\t</h2>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t<div class=\"pull-left\">申请会议室</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"/lavaFAQ/pages/user/addApplyUser?id=");
      out.print(person.getId());
      out.write("&username=");
      ...
      out.write("color:#333; \">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<button class=\"btn btn-info\">申请预约</button>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</tr>\r\n");
