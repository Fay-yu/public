 ...
 * Generated at: 2018-11-29 02:53:15 UTC
...
String basePath = request.getScheme()+"://"+request.getServerName()+":"+request.getServerPort()+path+"/";
      ...
      out.write("\t\t\t\t\t<i class=\"icon-table\"></i> 查看用户\r\n");
      out.write("\t\t\t\t</h2>\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<td>普通用户 <a\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\thref=\"/lavaFAQ/pages/main/Grant?id=");
      out.print(person.getId());
      out.write("\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tonclick=\"return myclick();\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\tstyle=\"text-decoration:none; color:#333; \">  <span\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\tclass=\"label label-success\">授权管理员</span>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t");
