...
public class MailUtils {
	...
	//--------------参数---------------------
    public static final String FROM = "1392021027@qq.com";//发件人的email
    public static final String PWD = "lkvqeafgbzfffhjh";//发件人密码--邮箱密码
    public static final String URL = "http://192.168.1.94:8080/lavaFAQ/pages/login";//项目主页
    public static final int TIMELIMIT = 1000*60*60*24; //激活邮件过期时间24小时
    public static final String TITLE = "CRM系统账户激活邮件";
...
//---------------自定义函数-----------------
    ...
    public static Person sendSuccessMail(Person u,Apply apply) throws AddressException, MessagingException, NoSuchAlgorithmException {
    	String title = "CRM系统预约成功邮件";
        //注册邮箱
        String to  = u.getMail();
        //发送的邮箱内容
        String content = "<p>您好 O(∩_∩)O~~<br><br>您的预约已受理!<br><br>您预约的会议室为:"+apply.getFcrmname()+"<br><br>请在"
        		+apply.getBooktimebegin()+"之前到达会议室，完成会议后请在系统中点击完成此次预约。"
                +"<br></p>";
        //调用发送邮箱服务
        sendMailEntity(to, title, content);
        return u;
