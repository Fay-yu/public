...
<body onload="init()">
<% Person user =(Person) request.getSession().getAttribute("user"); //获取你的对象里面涵盖的内容%>
	<!--页头  start -->
	<nav class="navbar navbar-default navbar-fixed-top"><!-- style="background:#B5CCDA" -->
		<div class="container">
			...
			<div class="navbar-header">
				...
				<%-- <c:forEach items="${sessionScope.userList}" var="str">
					${str.username}
				</c:forEach>  --%>
				<%=user.getUsername()%>
				</a>
	...
	<div class="container">
		...
		<form class="form-horizontal" id="top-from" accept-charset="utf-8" name="faqedit" action="<%=basePath%>pages/faq/faqEdit" method="post"  onsubmit="return checkinput()">
