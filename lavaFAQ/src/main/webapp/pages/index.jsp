...
<div class="content">
    ...
    <div class="sidebar">
        ...
        <ul id="nav">
          ...
          <li><a href="<%=basePath%>pages/main/widgets1" target="ifrmain" class="open"><i class="icon-home"></i> 首页</a>
            <!-- Sub menu markup 
            <ul>
             ...
             <li><a href="<%=basePath%>pages/user/tocheckcon"target="ifrmain"><i class="icon-bar-chart"></i>查看会议室</a></li> 
          </li>  
          <li class="has_sub"><a href="#"><i class="icon-file-alt"></i>预约管理 <span class="pull-right"><i class="icon-chevron-right"></i></span></a>
            <ul>
              <li><a href="<%=basePath%>pages/user/toAddApply" target="ifrmain">申请预约</a></li>
              <li><a href="<%=basePath%>pages/user/toMyApply?userid=<%=user.getId()%>" target="ifrmain">我的预约</a></li>
            </ul>
          </li> 
    ...
    <!-- Sidebar ends -->
  	  	...
  	  	<!-- Main bar -->
  	<div class="mainbar">
      <iframe src="<%=basePath%>pages/main/widgets1" name="ifrmain" class="container" style="height: auto;height: 1000px;border:0px;padding:0px;margin:0px"scrolling="no" ></iframe>
	<!--     Page heading
	    <div class="page-head">
